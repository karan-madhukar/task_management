defmodule TaskManagementWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: TaskManagementWeb

      import Plug.Conn
      import TaskManagementWeb.Gettext
      alias TaskManagementWeb.Router.Helpers, as: Routes
    end
  end
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/task_management_web/templates",
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {TaskManagementWeb.LayoutView, "live.html"}
